...
<pre>
# Precompile asset themes
config.assets.precompile += ['[theme]/stylesheets/theme.css']

# Enable digest on Themes for Rails assets
config.assets.digest_themes_for_rails = true
</pre>
